...
class HistoryController extends Controller
{
    ...
    /**
     * Displays a single HistoryService model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new HistoryService model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new HistoryService();
    ...
    /**
     * Updates an existing HistoryService model.
    ...
    /**
     * Deletes an existing HistoryService model.
